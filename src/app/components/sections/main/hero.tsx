                        ...
                        <div className="relative">
                            ...
                            <div className="hidden lg:block">
                                ...
                                <div className="hidden sm:block">
                                    <div className="before:w-24 before:h-24 before:absolute before:-top-3 before:end-2 before:-z-10 before:bg-[url('../images/pattern/dot3.svg')]" />
                                    <div className="after:w-24 after:h-24 after:absolute after:bottom-10 after:-z-10 after:bg-[url('../images/pattern/dot3.svg')]" />
                                </div>
                            </div>
                        </div>
                    </div>
